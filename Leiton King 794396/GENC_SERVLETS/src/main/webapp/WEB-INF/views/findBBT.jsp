...
<body>
<form id="formByID" method = "post" action = "findBBTView">
    <div class="form-group type1">
        <label for="bookTitle">Author Name:</label>
        <input type="text" step = "1" class="form-control" id="bookTitle" name="book_title" placeholder="Book Title" pattern="[a-zA-Z]*">
    </div>
