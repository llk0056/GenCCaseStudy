...
<head>
    ...
    <title>Search Author By ID</title>
    <%@include file="navbar.jsp" %>
</head>
    <body>
        <form name = "insertForm" id="formByID" method = "post" action="insertView">
            <div class="form-group type1">
                <input type="text" class="form-control" id="Name" name="name" placeholder="Author's Name">
            </div>
...
<script>
    /*function checkForm() {
        ...
        if (x == "") {
            ...
            window.location.replace("insertAllView");
        }
    }*/
</script>