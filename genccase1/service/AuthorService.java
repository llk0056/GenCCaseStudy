...
public class AuthorService {
    ...
    public HashMap<Author, ArrayList<Book>> addEntry(String name, String t, int p, String i, String g){
        if(name == null) throw new NullPointerException(name + " is not recognized by this system.");
        else if(t == null) throw new NullPointerException(t + " is not recognized by this system.");
       //else if(p == nl) throw new InputMismatchException(p + " is not recognized by this system.");
        else if(i == null) throw new NullPointerException(i + " is not recognized by this system.");
        else if(g == null) throw new NullPointerException(g + " is not recognized by this system.");
        else{
